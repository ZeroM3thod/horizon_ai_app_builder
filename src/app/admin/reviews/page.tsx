...
const INITIAL_REVIEWS: Review[] = [
  ...
  {id:4,  name:'Tanvir Rahman',    initials:'TR', color:3, product:'Turmeric Powder',    content:'Color and texture is perfect. I\'ve been searching for pure turmeric for years — finally found it here at Khati Family.',     rating:5, date:'25 May 2025',status:'approved'},
  ...
  {id:14, name:'Nasima Tuli',      initials:'NT', color:3, product:'Cloves Whole',       content:'Perfect for tea and biryani. Aromatic and beautifully clean. Exactly what I expect from Khati Family every time.',        rating:5, date:'20 Apr 2025',status:'approved'},
