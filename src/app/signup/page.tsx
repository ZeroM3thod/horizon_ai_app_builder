          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="hidden lg:flex flex-col justify-center pr-8 animate-slide-up">
              <div className="inline-flex items-center gap-2 bg-surface/70 backdrop-blur-xl border border-outline-variant/50 rounded-full px-4 py-2 mb-8 shadow-sm w-fit">
                <span className="bg-secondary-container text-on-secondary-container font-label-caps text-label-caps px-2 py-1 rounded-full uppercase">Free</span>
                <span className="font-body-md text-body-md text-on-surface">No credit card required</span>
              </div>
              <h1 className="font-display-xl text-[52px] leading-[1.1] tracking-tighter text-on-surface mb-6">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-outline text-[18px] md:text-[20px] pointer-events-none">person</span>
                        <input type="text" id="last-name" placeholder="Uddin" value={formData.lastName} onChange={handleInputChange} className="input-field w-full bg-surface-container-low border border-outline-variant/60 rounded-full pl-10 md:pl-11 pr-4 py-3 md:py-3.5 text-[13px] md:text-body-md text-on-surface placeholder:text-outline/60 font-body-md" />
                      </div>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="relative flex">
                      ...
                      <input type="tel" id="phone" placeholder="01XXXXXXXXX" value={formData.phone} onChange={handleInputChange} className="input-field flex-1 bg-surface-container-low border border-l-0 border-outline-variant/60 rounded-r-full pr-4 pl-3 py-3 md:py-3.5 text-[13px] md:text-body-md text-on-surface placeholder:text-outline/60 font-body-md" style={{ borderRadius: "0 9999px 9999px 0" }} />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="pt-2">
                    <button type="button" onClick={handleSignUp} className="btn-primary w-full bg-primary text-on-primary font-semibold text-[14px] md:text-body-lg py-3.5 md:py-4 rounded-full shadow-lg flex items-center justify-center gap-2.5 group">
      ...
      {showSuccessModal && (
        <div id="success-modal" className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-surface rounded-[28px] border border-outline-variant/40 shadow-2xl p-8 md:p-12 max-w-sm w-full text-center animate-slide-up">
            ...
            <h3 className="font-display-xl text-[24px] text-on-surface tracking-tight mb-2">You&apos;re in!</h3>
